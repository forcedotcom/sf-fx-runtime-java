...
public class QueryNextRecordsRestApiRequest implements RestApiRequest<QueryRecordResult> {
    ...
    @Override
    public QueryRecordResult processResponse(int statusCode, Map<String, String> headers, JsonElement json) {
        ...
        for (JsonElement jsonElement : body.get("records").getAsJsonArray()) {
            ...
            final Map<String, JsonPrimitive> attributes = gson.fromJson(attributesObject, new TypeToken<Map<String, JsonPrimitive>>(){}.getType());
