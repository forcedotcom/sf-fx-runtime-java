...
public abstract class Project {
  ...
  public abstract List<Path> getClasspathPaths();

  /**
   * Creates a class loader for this project. It also allows the caller to inject JAR files that do
   * not originate from project. Injected JAR files are guaranteed to come first in the class loader
   * created by this method. The main use-case for this is injecting slf4j logger bindings into the
   * project, ensuring they are picked up before any other bindings within the project.
   *
