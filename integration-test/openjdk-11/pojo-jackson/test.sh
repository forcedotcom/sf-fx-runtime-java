...
grep -xq '{"result":"Hello Katrin, you are 36 years old."}' "${function_invocation_response_file}"
grep -q "Found function: com.salesforce.PojoJacksonFunction" "${runtime_output_logfile}"
