...
java -jar ../../sf-fx-runtime-java-runtime/target/sf-fx-runtime-java-runtime-*-jar-with-dependencies.jar serve -p "${port}" "${test_dir}" >"${runtime_output_logfile}" &
runtime_pid=$!
...
grep -q "logging" "${runtime_output_logfile}"
