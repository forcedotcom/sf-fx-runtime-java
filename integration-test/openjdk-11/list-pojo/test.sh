...
grep -xq '{"result":"Hello Jonas, you are 0 years old! - Hello Johanna, you are 5 years old!"}' "${function_invocation_response_file}"
grep -q "Found function: com.salesforce.ListPojoFunction" "${runtime_output_logfile}"
